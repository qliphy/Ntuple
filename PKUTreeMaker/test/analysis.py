...
#                                    photonSrc = cms.InputTag("goodPhotons"),
                                    ...
                                    elPaths1     = cms.vstring("HLT_Ele23_WPTight_Gsf_v*","HLT_Ele23_WPLoose_Gsf_v"),
                                    elPaths2     = cms.vstring("HLT_Ele27_eta2p1_WPTight_Gsf_v*","HLT_Ele27_eta2p1_WPLoose_Gsf_v*"),
                                    muPaths1     = cms.vstring("HLT_IsoMu20_v*","HLT_IsoTkMu20_v*"),
                                    muPaths2     = cms.vstring("HLT_IsoTkMu22_v*","HLT_IsoMu22_v*"),
